...
import logo from '../../assets/images/ableton-black.svg'
import fb from '../../assets/images/fb.png'
import tw from '../../assets/images/tw.png'
import yt from '../../assets/images/yt.png'
import ig from '../../assets/images/ig.png'
import logod from '../../assets/icons/Logo.png'
export const Footer = () => {
  return (
    <StyledFooter>
        <div className="div-1">
        ...
        <div className="div-3">
            <div className="div-3a">
                <h3>Community</h3>
                <p><a href='/'>Find Ableton User group</a></p>
                <p><a href='/'>Find Certified Training</a></p>
                <p><a href='/'>Become a Certified Trainer</a></p>
            </div>
            <div className="div-3b">
                <h3>Distributors</h3>
                <p><a href='/'>Find Distributors</a></p>
                <p><a href='/'>Try Push in-store</a></p>
            </div>
